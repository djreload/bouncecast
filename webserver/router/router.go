...
func Start(enableVerboseLogging bool) error {
	...
	r.Options("/api/admin/bouncecast/integrations/facebook-messenger-alerts", middleware.RequireAdminAuth(adminhandlers.GetBounceCastFacebookMessengerAlerts))
	r.Get("/api/admin/bouncecast/integrations/facebook-messenger-alerts", middleware.RequireAdminAuth(adminhandlers.GetBounceCastFacebookMessengerAlerts))
	...
	r.Post("/api/admin/bouncecast/integrations/facebook-messenger-alerts/preview", middleware.RequireAdminAuth(adminhandlers.PreviewBounceCastFacebookMessengerAlert))
	r.Get("/api/admin/bouncecast/integrations/facebook-messenger-alerts/recipients", middleware.RequireAdminAuth(adminhandlers.GetBounceCastFacebookMessengerAlertRecipients))
