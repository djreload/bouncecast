...
func Start(enableVerboseLogging bool) error {
	...
	r.Options("/api/mobile/v1/config", handlers.MobileOptions)
	r.Get("/api/mobile/v1/config", handlers.GetMobileConfig)
	r.Options("/api/mobile/v1/theme", handlers.MobileOptions)
	r.Get("/api/mobile/v1/theme", handlers.GetMobileTheme)
	r.Options("/api/mobile/v1/navigation", handlers.MobileOptions)
	r.Get("/api/mobile/v1/navigation", handlers.GetMobileNavigation)
	r.Options("/api/mobile/v1/features", handlers.MobileOptions)
	r.Get("/api/mobile/v1/features", handlers.GetMobileFeatures)
	r.Options("/api/mobile/v1/assets", handlers.MobileOptions)
	r.Get("/api/mobile/v1/assets", handlers.GetMobileAssets)
	r.Options("/api/mobile/v1/legal", handlers.MobileOptions)
	r.Get("/api/mobile/v1/legal", handlers.GetMobileLegal)
	r.Options("/api/mobile/v1/stream-status", handlers.MobileOptions)
	r.Get("/api/mobile/v1/stream-status", handlers.GetMobileStreamStatus)
	r.Options("/api/mobile/v1/chat/config", handlers.MobileOptions)
	r.Get("/api/mobile/v1/chat/config", handlers.GetMobileChatConfig)
	r.Options("/api/mobile/v1/ads", handlers.MobileOptions)
	r.Get("/api/mobile/v1/ads", handlers.GetMobileAds)
	r.Options("/api/mobile/v1/notifications/config", handlers.MobileOptions)
	r.Get("/api/mobile/v1/notifications/config", handlers.GetMobileNotificationsConfig)
	r.Options("/api/mobile/v1/devices/register", handlers.MobileOptions)
	r.Post("/api/mobile/v1/devices/register", handlers.RegisterMobileDevice)
	r.Options("/api/mobile/v1/devices/unregister", handlers.MobileOptions)
	r.Post("/api/mobile/v1/devices/unregister", handlers.UnregisterMobileDevice)
	r.Options("/api/mobile/v1/devices/preferences", handlers.MobileOptions)
	r.Put("/api/mobile/v1/devices/preferences", handlers.UpdateMobileDevicePreferences)
	r.Post("/api/mobile/v1/devices/preferences", handlers.UpdateMobileDevicePreferences)
